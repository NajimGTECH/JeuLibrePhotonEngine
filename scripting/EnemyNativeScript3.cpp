...
class EnemyNativeScript3 : public Engine::Scripting::NativeScript {
public:

    bool invertEnemyDir = false;
    float speed = 0.2f;
    float PointCheck1 = 2.075f;
    float PointCheck2 = 2.875f;
    ...
    void FindTarget() {
        for (auto e : registry->View<Engine::Components::Transform>()) {
            if (registry->GetEntityName(e) == "Enemy_3") {
                targetEnemy = e;
            }
        }
    }
